...
function youtube_post_post_type() {

	$labels = array(
		'name'                  => _x( 'Posty z YouTube', 'Post Type General Name', 'dobry-hasztag' ),
		'singular_name'         => _x( 'Post z YouTube', 'Post Type Singular Name', 'dobry-hasztag' ),
		'menu_name'             => __( 'YouTube', 'dobry-hasztag' ),
		'name_admin_bar'        => __( 'YouTube', 'dobry-hasztag' ),
	...
	$args = array(
		...
		'show_ui'               => true,
		'show_in_menu'          => true,
        'menu_icon'             => 'data:image/svg+xml;base64,' . base64_encode(file_get_contents(IMG . 'yt.svg')),
		'menu_position'         => 5,
