<section>
    <div class=" border-t-8 border-b-8 py-10 bg-white relative overflow-hidden">
        ...
        <figure class="absolute left-10 -bottom-16 h-2/3">
            <img src="<?php echo IMG . "kciuk_bg_09.png" ?>"
                 alt="Udostępnij #dobryhasztag"
                 class="h-full w-auto">
        </figure>
        <figure class="absolute left-20 -bottom-16 h-full  animate-cut-to-left">
            <img src="<?php echo IMG . "kciu-sam_06.png" ?>"
                 alt="Udostępnij #dobryhasztag"
                 class="h-full w-auto ">
        </figure>

        <figure class="absolute -right-10 -bottom-20 h-full animate-cut-to-right">
    ...
    <div class="grid grid-cols-5">
        <a href="https://www.facebook.com/sharer/sharer.php?u=https://dobryhasztag.pl"
           target="_blank"
           class="flex items-center justify-center p-10 bg-fb hover:bg-yellow cursor-pointer transition-all">
            <img src="<?php echo IMG . "share/facebook.svg" ?>"
                 alt="Udostępnij na FB"
                 class="w-16 h-16 el-drop-shadow">
        </a>
        <a href="https://api.whatsapp.com/send?text=https://dobryhasztag.pl"
           class="flex items-center justify-center p-10 bg-wa hover:bg-yellow cursor-pointer transition-all">
            <img src="<?php echo IMG . "share/whatsapp.svg" ?>"
                 alt="Udostępnij na FB"
                 class="w-16 h-16 el-drop-shadow">
        </a>
        <a href="https://twitter.com/intent/tweet?url=https://dobryhasztag.pl"
           class="flex items-center justify-center p-10 bg-twi hover:bg-yellow cursor-pointer transition-all">
            <img src="<?php echo IMG . "share/twitter.svg" ?>"
                 alt="Udostępnij na FB"
                 class="w-16 h-16 el-drop-shadow">
        </a>
        <a href="https://www.linkedin.com/sharing/share-offsite/?url=https://dobryhasztag.pl"
           class="flex items-center justify-center p-10 bg-li hover:bg-yellow cursor-pointer transition-all">
        ...
        <a href="#"
           ...
           class="flex items-center justify-center p-10 bg-share hover:bg-yellow cursor-pointer transition-all">
