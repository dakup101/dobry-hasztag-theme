<section class="bg-dark mt-10 py-5 text-yellow">
    <div class="container mx-auto grid grid-cols-3 items-center gap-5">
        ...
        <div class="col-span-3 md:col-span-1 flex justify-center items-center text-center opacity-70">
            Wszelkie prawa zastrzeżone © #dobryhasztag 2023
        </div>
        <div class="col-span-3 md:col-span-1 flex justify-center md:justify-end items-center">
            <a href="https://everywhere.pl/"
               class="flex items-center hover:text-rose">
                <span>Projekt &<br>Realizacja</span>
                <img src="<?php echo IMG . "ev_logo.svg"; ?>"
                     alt="Everywhere Polska"
                     class="h-14 ml-4">
            </a>
        </div>
    </div>
