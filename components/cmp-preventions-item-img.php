...
<article class="neo-before mb-1.5 mr-1.5">
    <div class="relative bg-white border-4 border-dark rounded-xl px-10 py-5">
        <div class="grid grid-cols-5 gap-10">
            <div class="col-span-3 <?php echo $args["img_pos"] == "right" ? "order-last" : "order-first" ?>">
            ...
            <div class="col-span-2 <?php echo $args["img_pos"] == "right" ? "order-first" : "order-last" ?>">
