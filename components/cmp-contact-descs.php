<div class="grid grid-cols-3 gap-16">
    <div class="neo-before mb-1.5 mr-1.5">
        <div class="relative bg-cyan-lighter rounded-xl border-4 border-dark px-10 py-5">
    ...
    <div class="neo-before mb-1.5 mr-1.5">
        <div class="relative bg-rose-lighter rounded-xl border-4 border-dark px-10 py-5">
            <h2 class="font-sofia text-4xl mb-5">
    ...
    <div class="neo-before mb-1.5 mr-1.5">
        <div class="relative bg-yellow-lighter rounded-xl border-4 border-dark px-10 py-5">
            <h2 class="font-sofia text-4xl mb-5">
